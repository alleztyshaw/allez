...
export default function Team() {
  ...
  // If coming from Orgs page with ?org= param, use that org
  const queryOrg = new URLSearchParams(location.search).get('org');
  ...
  const [selectedOrg, setSelectedOrg] = useState(queryOrg || null);
